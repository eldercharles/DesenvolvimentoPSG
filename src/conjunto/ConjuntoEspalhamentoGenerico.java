...
public class ConjuntoEspalhamentoGenerico {
	...
	public int tamanho() {
		return this.tamanho;
	                                                  ...
	                                                  //Métodos toLowerCase() e chatAt(int)
	                                                  //da classe String. O primeiro devolve a palavra em 
	                                                  //letras minúsculas. O segundo devolve o caracter
	                                                  //e na posição passada como parâmetro. 
